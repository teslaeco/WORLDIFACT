# Project vision — planned scope

Preserved from the main-branch README at `ba6bca908122b0e5b9d16dd01ca37933a402ba5c`. The text below describes the intended product. It is not a claim that every portal, manufacturing flow or integration is implemented. See the root README and `CONTEST_STATUS.md` for verified behavior.
