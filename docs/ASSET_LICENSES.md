...
| `public/brands/product-hunt-white.png` | [Product Hunt branding](https://www.producthunt.com/branding), [official white horizontal logo](https://ph-static.imgix.net/product-hunt-logo-horizontal-white.png) | Unmodified official horizontal white logo; links to the existing WORLDIFACT listing. |
