...
- The public runtime uses a separately identified GAME-optimized derivative, SHA-256 `032d4cb75880d75d8b78493fe75babefea64676b041389fe23e17a362d982ccd`, 98,392 bytes after decompression, with simplified geometry/materials for browser delivery. It is not represented as the untouched source and is not a manufacturing file.
- Runtime transport files: `public/world-assets/giant-building/part-00.b64` through `part-03.b64`. See `public/world-assets/giant-building/README.md` for provenance and limits.
