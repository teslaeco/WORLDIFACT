...
- Runtime transport files: `public/world-assets/giant-building/part-00.b64` through `part-09.b64`. See `public/world-assets/giant-building/README.md` for provenance and limits.
...
- The landship is static GAME scenery beside the existing photovoltaic explorer. No rig, driveability, engineering approval, manufacturing readiness or supplier approval is claimed.
