...
test('visual reference count combines photos with prepared model/video/image previews', () => {
  const photo = { name: 'front.jpg', view: 'front', dataUrl: 'data:image/jpeg;base64,AAAA', textureMaxSize: 2048 }
  const attachment = {
    key: 'a', file: {}, name: 'movie.mp4', mime: 'video/mp4', bytes: 100,
    category: 'video', previewPhoto: { ...photo, name: 'movie frame', view: 'detail' }, needsServerAnalysis: false,
  }
