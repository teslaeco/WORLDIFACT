...
export const GIANT_BUILDING_GAME_SHA256 = "841320411b2ffb176231e239c0fe72f106f964166e2ddf28a348eeb7c7e26199";
export const GIANT_BUILDING_SOURCE_TRIANGLES = 242_120;
export const GIANT_BUILDING_GAME_TRIANGLES = 15_325;
...
export async function loadGiantBuilding(fetcher: typeof fetch = fetch) {
  ...
  root.userData.provenance = "OWNER_PROVIDED_SOURCE__GAME_OPTIMIZED_DERIVATIVE";
