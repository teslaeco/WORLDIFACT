...
export default function InfoPage({ kind }: { kind: "privacy" | "terms" }) {
  return (
    <main className="info-page">
      ...
      <p>Updated 21 September 2026. WORLDIFACT is an early playable prototype.</p>
      {kind === "privacy" ? <>
