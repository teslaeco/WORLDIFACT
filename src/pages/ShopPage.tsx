    ...
    <section className="native-shop-workspace" aria-label="Create and preview a 3D product">
      ...
      <div className="native-shop-form">
        ...
        <form onSubmit={generate} aria-describedby="studio-draft-help">
          ...
          <button className="native-shop-generate" type="submit" disabled={!canGenerate}>{busy ? 'Creating your model…' : fast ? 'Generate FAST 3D draft + materials · free' : 'Generate SLOW quality 3D model + materials · free'}</button><small>No customer payment is taken at generation. Manufacturing and delivery are a separate purchase step.</small>
        </form>
