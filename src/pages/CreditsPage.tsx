...
function CreditsContent({ user, loading }: { user: AccountUser | null; loading: boolean }) {
  ...
  return <main className="credits-page">
    ...
    <section className="credits-heading"><span>MAKE ROOM FOR YOUR NEXT IDEA</span><h1>More worlds.<br /><em>More possibilities.</em></h1><p>Explore for free, become a member for $29.99 USD per month, or add a one-time 1,500-credit pack for $30 USD.</p></section>
