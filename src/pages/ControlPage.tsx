...
const labels: Record<string, string> = {
  ...
  CONNECTOR_READY: 'Connector reports ready; rendering not tested', CONNECTOR_NOT_READY: 'Connector reports not ready',
}
const editors = [
...
export default function ControlPage() {
  ...
  return <main className="control-page">
    ...
    <div className="control-worlds">
      {FOUNDATIONS.slice(0, 5).map((world, i) => <article key={world.id}>
    ...
    </div><p>Scene changes are local to this browser until exported. This panel does not yet provide shared editing or publishing for all five applications.</p></section>
  </main>
}
